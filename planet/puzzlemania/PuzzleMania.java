...
//        }
    ...
    public void updateResult() {
        ...
        if (this.adventureGameView.model.player.getLives() > 0) {
            if (pieceTrack.isEmpty()) {
                ...
                ArrayList<Node> cell_2_1= new ArrayList<>();
                for (javafx.scene.Node node : this.adventureGameView.gridPane.getChildren()) {
                    Integer rowIndex = GridPane.getRowIndex(node);
                    Integer columnIndex = GridPane.getColumnIndex(node);

                    if (rowIndex != null && columnIndex != null && rowIndex == 2 && columnIndex == 1) {
                        cell_2_1.add(node);
                    }
                }
                this.adventureGameView.gridPane.getChildren().removeAll(cell_2_1);
                this.adventureGameView.gridPane.add(this.adventureGameView.inputTextField, 1, 2);
                this.adventureGameView.inputTextField.setVisible(true);
    ...
    public void updateObject() {
        this.adventureGameView.gridPane.getChildren().remove(1, 2);
